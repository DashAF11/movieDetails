package com.example.moviedetails.data.networkWrapper

import android.accounts.NetworkErrorException
import com.example.moviedetails.data.pojo.DataState
import com.example.moviedetails.data.pojo.ErrorResponse
    ...
    suspend fun <T : Any> apiRequest(dataRequest: suspend () -> T): DataState<T> {
        return try {
            if (networkHelper.isNetworkConnected()) {
                ...
                val throwable = NetworkErrorException("Please check your Internet Connection")
